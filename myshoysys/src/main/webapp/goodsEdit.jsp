...
<form action="/com.ylw.shopsys/goods/doUpdate" method="post">  
<%--         <input type="hidden" name="id" value="${user.id }">   --%>
        编号：<input type="text" name="goods_id" value="${goods['goods_id']}"><br/>  
        ...
        库存数量： <input type="text" name="goods_number" value="${goods['goods_number']}"><br/> 
